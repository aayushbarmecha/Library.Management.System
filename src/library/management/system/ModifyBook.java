...
public class ModifyBook extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel11.setText("Modify Book Information");
    ...
    public void confirmation(){
        String confirmation = JOptionPane.showInputDialog(null,"Type CONFIRM to modify book information", "Confirm", JOptionPane.PLAIN_MESSAGE).toUpperCase();
        if (confirmation.equals("CONFIRM")){
            isConfirmed = true;
        }
    }
    
    public void passInfo(String bookID){
        BookID = bookID;
    ...
    private void saveChangesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveChangesActionPerformed
        ...
        if (isConfirmed == true){
            try {
                conn con = new conn();
                String sql = "UPDATE book SET name=?, isbn=?, publisher=?, edition=?, price=?, pages=? WHERE book_id="+BookID;
                PreparedStatement st = con.c.prepareStatement(sql);
                st.setString(1, nameTF.getText());
                st.setString(2, isbnTF.getText());
                st.setString(3, publisherTF.getText());
                st.setString(4, editionTF.getText());
                st.setString(5, priceTF.getText());
                st.setString(6, pagesTF.getText());
                st.executeUpdate();
                JOptionPane.showMessageDialog(null,"Book information successfully modified", "Success!", JOptionPane.PLAIN_MESSAGE);
                CheckUser check = new CheckUser();
                String user = check.checkUser();
                Logs write = new Logs();
                write.log("Librarian "+user+" updated book ID "+BookID+" information");
